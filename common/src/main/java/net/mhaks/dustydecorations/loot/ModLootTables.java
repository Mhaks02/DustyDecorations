package net.mhaks.dustydecorations.loot;
...
public class ModLootTables {
    ...
    public static final ResourceKey<LootTable> SUS_SEAGLASS = register("archaeology/seaglass");

    private static ResourceKey<LootTable> register(String name) {
        return register(ResourceKey.create(Registries.LOOT_TABLE, ModConstants.identifierOf(name)));
    }
