...
//                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.BEET_O_LANTERN.get())
                .pattern("#")
                .pattern("I")
...
//                .unlockedBy("has_leaf_litter", has(Blocks.LEAF_LITTER))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.GIANT_CHAIN.get())
                .pattern("NI")
                .pattern("IN")
                .pattern("NI")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.PLAIN_CUSHION_BLOCK.get(), 8)
                .pattern("@#@")
                .pattern("#o#")
                .pattern("@#@")
